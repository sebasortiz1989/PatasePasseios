...
/// <remarks>
/// <para>
/// Named for the screen rather than called <c>Selection</c> outright: that name is also
/// <c>Avalonia.Controls.Selection</c>, and CA1724 fails the Release build over the collision.
/// <see cref="AppSession.Selection"/> is still the property, so nothing reads differently.
/// </para>
/// <para>
...
public readonly record struct ScreenSelection(int? DogId, int? TutorId, ServiceKind? Kind, int? ServiceId);
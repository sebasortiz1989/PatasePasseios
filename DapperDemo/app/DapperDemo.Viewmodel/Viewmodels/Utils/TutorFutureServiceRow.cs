...
/// </summary>
public sealed class TutorFutureServiceRow(string dogName, string typeLabel, string dateLabel, bool paid, string paidLabel, bool done, string doneLabel, ICommand openCommand) : IDisposable
{

...
> Paste everything below into Claude Design. Attach the Nib folder
> (`NibHub/DesignDocs/ClaudeDesign/2026-08-19_nib-browsing-surface/`) alongside it —
> the v3 spec and the decisions file are the reference, `2026-08-19_nib-browsing-surface-v3.dc.html`
> is what it looks like built.
